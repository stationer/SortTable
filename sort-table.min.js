...
sortTable.number=function(a){return Number(sortTable.stripTags(a.innerHTML).replace(/\$|%|,/g,""))};sortTable.string=function(a){return sortTable.stripTags(a.innerHTML).toLowerCase()};sortTable.last=function(a){return sortTable.stripTags(a.innerHTML).split(" ").pop().toLowerCase()};sortTable.input=function(a){for(var c=0;c<a.children.length;c++)if("object"==typeof a.children[c]&&"undefined"!=typeof a.children[c].value)return a.children[c].value.toLowerCase();return sortTable.string(a)};
